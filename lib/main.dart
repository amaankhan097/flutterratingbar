  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Builder(builder: (context) => Scaffold(
        ...
        body: Directionality(
          textDirection: _isRTLMode ? TextDirection.rtl
          : TextDirection.ltr,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children:<Widget>[
                    Text('Switch to RTL Mode',
                    style: TextStyle(fontWeight: FontWeight.w300),
                    ),
                    Switch(value: _isRTLMode,
                        onChanged: (value) {
                      setState(() {
                        _isRTLMode = value;
                      });
      ...
      case 2:
        return RatingBar(
          ...
          ratingWidget: RatingWidget(
              full: _image('assets/heart.jpg'),
              half: _image('assets/download.png'),
              empty: _image('assets/images.png'),
          ),
          itemPadding: EdgeInsets.symmetric(horizontal: 4.0),
          onRatingUpdate: (rating) {
              setState(() {
